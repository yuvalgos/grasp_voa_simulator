...
simulator = GraspSimulator(launch_viewer=True, real_time=True, obj_file='../data/world_endstop_holder.xml')
...
simulator.reset(object_orientation=[0, pi, -pi/2], object_position_offset=[-0.01, 0, 0.1])
simulator.simulate_seconds(0.5)
res = simulator.try_grasp([0, 0, 0.01], [0, pi/2, 0])
print("--------grasp result: ", res)
...
# simulator.reset()
# simulator.simulate_seconds(0.5)
# res = simulator.try_grasp(ee_pos_table=[0, 0, 0.20], ee_orientation=[0, 0, pi])
# print("--------grasp result: ", res)
