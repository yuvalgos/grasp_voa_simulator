...
if __name__ == '__main__':
    obj = 'endstop_holder'
    grasps_file = '../config/grasps/endstop_holder_grasps.yaml'
    ...
    trails_per_pair = 100
    simulator = GraspSimulator(launch_viewer=False, real_time=False, obj_file='../data/world_endstop_holder.xml')
    ...
    with open('../results/grasp_score/' + obj + '/' + str(max_translation_noise) + '.csv', mode='w',
              newline='') as csv_file:
