...
if __name__ == '__main__':
    grasps_file = '../config/grasps/sprayflask_grasps.yaml'
    ...
    trails_per_pair = 100
    simulator = GraspSimulator(launch_viewer=False, real_time=False, obj_file='../data/world_sprayflask.xml')
    ...
    max_rotation_noise = float(np.radians(1))
    ...
    with open('../results/grasp_score/sprayflask_' + str(max_translation_noise) + '.csv', mode='w', newline='') as csv_file:
